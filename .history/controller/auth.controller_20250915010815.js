...
const createSendToken = (user, statusCode, res) => {
  const token = authService.generateToken(use);
...
exports.signup = catchAsync(async (req, res, next) => {
  //just validation here in controller layer
  //transfer buissness logic to service layar
  //transfer db logic to repository layer
